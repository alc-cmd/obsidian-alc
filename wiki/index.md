...
- [[Context Window Management]] — Controlling what loads into LLM context to maximize output quality
- [[Epistemic Commons]] — The shared public information environment; contaminated by engagement-optimized content
- [[Hermes Agent]] — Nous Research open-source AI Agent with self-improving learning loop, three-layer memory, and Skill auto-evolution
- [[Intelligence Explosion]] — Recursive self-improvement feedback loop where AI accelerates AI research
- [[Iterated Distillation and Amplification]] — Training paradigm alternating amplification and distillation for self-improvement
